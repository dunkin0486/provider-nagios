...
// no dependency on crossplane-runtime so it can be built and unit tested
// standalone. Ported from dunkin0486/terraform-provider-nagios's
// internal/client, which documents the API quirks encoded here in more
// detail.
package client
