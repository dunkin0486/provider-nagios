...
// TestDeleteService_JoinsMultipleHostsAndEscapesSpaces exercises
// DeleteService keying off (host_name, description), where host_name is the
// full host set comma-joined into one value, and a description containing a
// space.
