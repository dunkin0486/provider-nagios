...
XPKGS = provider-nagios
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-nagios: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Nagios CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Nagios controllers
...
# This target prepares repo for your provider by replacing all "nagios"
